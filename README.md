...
```javascript
import { Buffer, allocUnsafe, array2buffer, arraybuffer2buffer, buffer2json, copyBuffer, reviveBuffer, string2buffer } from 'https://cdn.jsdelivr.net/gh/stdlib-js/buffer@v0.1.0-deno/mod.js';
```
